...
## How to use
Clone the repo into it on your local computer/vm. Install the CompCars dataset from the Google Drive in the link https://mmlab.ie.cuhk.edu.hk/datasets/comp_cars/instruction.txt. Only install data files, ignore sv files. Please read the instructions on the stie on how to download. 
...
Create a virtual env and run pip install -r requirments.txt. 
